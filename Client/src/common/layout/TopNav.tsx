...
// TopNav is the main navigation bar for the logged-in area of the app.

import { useLayoutEffect, useRef, useState } from "react";

// shared logo and ui imports — same shared/ tree
import BudiLogo from "../logo/BudiLogo";
import AppButton from "../ui/AppButton";

// app.types lives in src/app/ — the Page union is application-wide
 ...
 * Contains:
 * - BudiFit logo
 * - Desktop navigation buttons with animated active indicator
    ...
    <nav className="sticky top-0 z-10 px-6 pt-4 backdrop-blur-md bg-[#fbfaf7]/85">
      <div className="grid grid-cols-[auto_1fr_auto] items-center gap-4 rounded-[22px] border border-slate-200/50 bg-white p-2.5 shadow-sm">
        ...
        <div className="relative flex justify-center min-w-0">
          ...
          >
            {/* Animated purple active indicator */}
            <div
