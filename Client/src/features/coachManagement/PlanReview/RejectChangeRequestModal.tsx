  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-xl">
        <h2 className="text-lg font-extrabold text-slate-900">Reject change request?</h2>
        <p className="mt-2 text-sm text-slate-600">
          <span className="font-semibold">{traineeName}</span> requested changes to{" "}
          <span className="font-semibold">"{planTitle}"</span>. The trainee will be notified
