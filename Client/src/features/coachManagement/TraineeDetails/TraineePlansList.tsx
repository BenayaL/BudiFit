...
function planBadgeClasses(plan: CoachPlan) {
  if (plan.approvalStatus === "pending_review") return "bg-orange-100 text-orange-700";
  if (plan.approvalStatus === "approved") return "bg-emerald-100 text-emerald-700";
            ...
            <article key={plan.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">{totalEx} exercises</p>
                </div>
