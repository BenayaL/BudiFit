...
interface ChallengeCardProps {
  ...
  accentColorLight: string;  // e.g. "#7C3AED18"
  barGradient: string;       // inline style gradient string
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3">
        <div
          className={`flex h-11 w-11 items-center justify-center rounded-xl text-xl flex-shrink-0 ${
            isComplete ? "bg-emerald-50" : iconBg
          }`}
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[10px] font-bold uppercase tracking-wide px-2.5 py-1 rounded-full bg-amber-50 text-amber-700">
          {reward}
        </span>
      </div>
    </div>
