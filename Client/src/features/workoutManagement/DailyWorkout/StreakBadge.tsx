...
export function StreakBadge({ streak }: StreakBadgeProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl border border-orange-200 bg-gradient-to-b from-orange-50 to-amber-50 px-6 py-5 shadow-sm">
